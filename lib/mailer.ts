  ...
  <table width="100%" style="max-width:600px;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 6px 32px rgba(0,0,0,0.09);">
    ...
    <tr>
      <td style="padding:36px 0 20px;">
        ...
        <img src="${SITE_URL}/interfaceclient.png" alt="Interface client" width="600" style="width:100%;max-width:600px;height:auto;display:block;margin:0 0 20px;" />
    ...
    <tr>
      <td style="padding:36px 0 20px;">
        ...
        <img src="${SITE_URL}/menuItems.png" alt="Gestion menu" width="600" style="width:100%;max-width:600px;height:auto;display:block;margin:0 0 20px;" />
        <p style="margin:0;padding:0 40px;color:#374151;font-size:15px;line-height:1.75;text-align:left;">
    ...
    <tr>
      <td style="padding:36px 0 20px;">
        ...
        <img src="${SITE_URL}/ordersDashboard.png" alt="Dashboard commandes" width="600" style="width:100%;max-width:600px;height:auto;display:block;margin:0 0 20px;" />
        <p style="margin:0;padding:0 40px;color:#374151;font-size:15px;line-height:1.75;text-align:left;">
    ...
    <tr>
      <td style="padding:36px 0 20px;">
        ...
        <img src="${SITE_URL}/waitersScreens.png" alt="App serveurs" width="600" style="width:100%;max-width:600px;height:auto;display:block;margin:0 0 20px;" />
        <p style="margin:0;padding:0 40px;color:#374151;font-size:15px;line-height:1.75;text-align:left;">
    ...
    <tr>
      <td style="padding:36px 0 36px;">
        ...
        <img src="${SITE_URL}/kds.png" alt="KDS" width="600" style="width:100%;max-width:600px;height:auto;display:block;margin:0 0 20px;" />
        <p style="margin:0;padding:0 40px;color:#374151;font-size:15px;line-height:1.75;text-align:left;">
